                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group form-floating-label">
                            <input id="inputFloatingLabel" type="text" class="form-control input-border-bottom" required="" name="nama_supp" value="{{ old('nama_supp', $data->nama_supp) }}">
                            <label for="inputFloatingLabel" class="placeholder">Nama Supplier</label>
                        </div>
                        <div class="form-group form-floating-label">
                            <input id="inputFloatingLabel" type="email" class="form-control input-border-bottom" required="" name="email" value="{{ old('email', $data->email) }}">
                            <label for="inputFloatingLabel" class="placeholder">Email</label>
                        </div>
                        <div class="form-group form-floating-label">
                            <input id="inputFloatingLabel" type="number" class="form-control input-border-bottom" required="" name="no_hp" value="{{ old('no_hp', $data->no_hp) }}">
                            <label for="inputFloatingLabel" class="placeholder">Nomer Hp</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <label for="">Alamat</label>
                        <textarea class="form-control" name="alamat" id="" cols="30" rows="7">{{ old('alamat', $data->alamat) }}</textarea>
                    </div>
                </div>
            </div>
        </div>
